...
const toJSON = <DocType = Document, SchemaDefinitionType = undefined>(
  ...
  const transform: (
    _model: Model<DocType>,
    _ret: Document<any, Record<string, never>, DocType>
  ) => void | undefined =
    typeof anySchema.options?.toJSON?.transform === "function"
  ...
  anySchema.options.toJSON = Object.assign(anySchema.options?.toJSON || {}, {
    ...
    transform(
      model: Model<DocType>,
      ret: Document<any, Record<string, never>, DocType>
    ): void {
